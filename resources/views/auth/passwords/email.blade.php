...
<div class="mx-auto h-screen flex justify-center items-center bg-gray-300">
    <div class="w-96 p-6 bg-blue-900 shadow-xl rounded">
        ...
        <h1 class="pt-8 text-white text-3xl">Oh no!</h1>
        <h2 class="text-blue-300">Enter your e-mail to reset password</h2>

        <form method="POST" action="{{ route('password.email') }}" class="pt-8">
            @csrf

            <div class="relative">
                <label for="email" class="absolute pl-3 pt-2 text-blue-500 uppercase text-xs font-bold">E-mail</label>

                    <input id="email" type="email" class="pt-8 w-full p-3 rounded bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="your@email.com" autofocus>
            ...
            <div class="pt-6">
                    <button type="submit" class="w-full text-left bg-gray-400 px-3 py-2 rounded uppercase text-blue-800 font-bold">
