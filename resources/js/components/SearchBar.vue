<template>
    <div>
        ...
        <div class="relative z-10">
            ...
            <input type="text" class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm
            ...
            <div v-if="focusCondition" class="absolute bg-blue-900 text-white rounded-lg p-4 w-96 right-0 mr-6 mt-2 shadow z-20">
    ...
    export default {
        ...
        computed: {
          focusCondition: function () {
              return this.focus === true && this.searchTerm !== '' && this.searchTerm.length >= 3;
          }
        },
        methods: {
