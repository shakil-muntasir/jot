<template>
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="pl-6 bg-gray-200 h-screen w-48 border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/contacts/create" class="flex items-center py-2 text-sm hover:text-blue-600">
                    ...
                    <router-link to="/contacts" class="flex items-center py-2 text-sm hover:text-blue-600">
                    ...
                    <router-link to="/birthdays" class="flex items-center py-2 text-sm hover:text-blue-600">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                    ...
                    <router-link to="/logout" exact-active-class="" class="flex items-center py-2 text-sm hover:text-blue-600">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                            <path
...
<style scoped>
    .router-link-exact-active {
        @apply .border-r-2 .border-blue-600 .font-bold
    }
</style>
